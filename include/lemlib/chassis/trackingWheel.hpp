...
class TrackingWheel {
    public:
         ...
         * @param distance distance between the tracking wheel and the center of rotation in inches
         * @param gearRatio gear ratio of the tracking wheel, defaults to 1
         * @param emaAlpha the alpha value for the exponential moving average, defaults to 0.875
         *
         * @b Example
         * @code {.cpp}
         ...
         * @endcode
         */
        TrackingWheel(pros::Rotation* encoder, EmaFilter* filter, float wheelDiameter, float distance, float gearRatio = 1);
        /**
         * @brief Create a new tracking wheel
         *
