...
class Chassis {
    public:
        ...
        void waitUntilDone();
        /**
         * @brief makes motion mirrored if mirror is true
         *
         * @param mirror if true, motion is mirrored
         *
         */
        void mirror(const bool mirror);
        /**
         ...
         * @endcode
         */
        void follow(const asset& path, float lookahead, int timeout, bool forwards = true, bool async = true, float stanleyGain = 1, float headingFF = .5);
        /**
