...
inline void oldskills() {
  ...
  chassis.moveToPoint(3, 50, 1000, {.maxSpeed = 80});
  chassis.waitUntil(6);
  intake.setState(lib::IntakeState::In);
  ...
  chassis.turnToPoint(-48, 50, 1000, {.maxSpeed = 75});
  ...
  chassis.turnToPoint(49, 14.5, 1000);
  chassis.moveToPoint(49, 14.5, 6000);
  chassis.swingToPoint(65, 75, lemlib::DriveSide::LEFT, 2000, {.maxSpeed = 80});
  chassis.moveToPoint(65, 75, 2000);

  chassis.moveToPoint(60, 40, 1500, {.forwards = false});
  intake.setState(lib::IntakeState::Out);

  chassis.turnToPoint(90, 40, 1000, {.forwards = false});
  chassis.moveToPoint(90, 40, 1000, {.forwards = false});
  intake.setState(lib::IntakeState::Idle);
  chassis.waitUntilDone();
  ...
  chassis.turnToPoint(48, 4, 1000, {.forwards = false});
  chassis.moveToPoint(48, 4, 1000, {.forwards = false, .maxSpeed = 80});
  chassis.waitUntilDone();
  clamp.extend();
  pros::delay(500);
