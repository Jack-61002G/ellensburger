...
inline void redRingSide() {
  ...
  chassis.turnToPoint(-50, 3, 500, {.maxSpeed = 90});
  chassis.moveToPoint(-50, 3, 1500, {.maxSpeed = 60});
...
inline void blueRingSide() {
  ...
  chassis.turnToPoint(35, 45, 1000, {.maxSpeed = 90});
  chassis.moveToPoint(35, 45, 1000, {.maxSpeed = 90});
  chassis.turnToPoint(49, 3, 500, {.maxSpeed = 90});
  chassis.moveToPoint(49, 3, 1500, {.maxSpeed = 60});
...
inline void redMogoRush() {
  ...
  chassis.moveToPoint(-15, -47.75, 2000);
  lift.setTarget(150);
  intake.setState(lib::IntakeState::In);
  ...
  intake.setState(lib::IntakeState::In);
  pros::delay(1500);
  chassis.turnToPoint(-42, -2.5, 1000);
  chassis.moveToPoint(-42, -2.5, 2000, {.maxSpeed = 75});
  pisstake.extend();

  chassis.waitUntilDone();
  pisstake.retract();
  pros::delay(1000);
  chassis.moveToPoint(-22, -32, 1000, {.forwards = false, .maxSpeed = 50});
  chassis.waitUntilDone();
  pros::delay(2000);
