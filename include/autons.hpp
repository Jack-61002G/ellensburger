...
inline void skills() {
  ...
  // Grab first mogo
  chassis.turnToPoint(-47, 24, 1000, {.forwards = false, .minSpeed = 80});
  chassis.waitUntilDone();
  lift.setTarget(0);
  ...
  chassis.moveToPoint(-48, 60, 1000, {.maxSpeed = 75});

  // drop the mogo
  chassis.turnToPoint(-61, 63, 1000, {.forwards = false, .maxSpeed = 75});
  chassis.moveToPoint(-61, 63, 1000, {.forwards = false});
  clamp.retract();

  // cross to blue corner
  chassis.turnToPoint(40, 46, 1000, {.minSpeed = 80});
  chassis.moveToPoint(40, 46, 5000, {.maxSpeed = 110});
  ...
  // grab blue goal
  chassis.turnToPoint(58, 24, 1000, {.forwards = false, .minSpeed = 80});
  ...
  chassis.moveToPoint(66, 66, 2000, {.maxSpeed = 80});
  pros::delay(200);
  intake.setState(lib::IntakeState::In);

  chassis.turnToPoint(0, 0, 2000, {.minSpeed = 80});
  chassis.moveToPoint(80, 80, 300, {.forwards = false});
  clamp.retract();
  pros::delay(500);
  ...
  chassis.moveToPoint(56, -1.25, 750, {.maxSpeed = 100});
  chassis.waitUntilDone();
  lift.setTarget(250);
  pros::delay(500);
  ...
  chassis.moveToPoint(-60, -48, 1000, {.maxSpeed = 80});
  ...
  chassis.turnToPoint(-48, -62, 1000, {.minSpeed = 80});
  chassis.moveToPoint(-48, -62, 1000, {.maxSpeed = 80});

  // drop off mogo
  chassis.turnToPoint(-60, -68, 1000, {.forwards = false , .minSpeed = 80});
  ...
  chassis.turnToPoint(0, -46, 1000, {.minSpeed = 80, .earlyExitRange = 10});
  chassis.moveToPoint(0, -46, 1500, {.maxSpeed = 100});
  chassis.waitUntil(12);
  lift.setTarget(75);
  intake.setState(lib::IntakeState::Idle);
  ...
  // turn to da wall
  chassis.turnToPoint(0, -65, 1000, {.maxSpeed = 100});
  chassis.moveToPoint(0, -65, 1000, {.maxSpeed = 100});
  chassis.waitUntil(10);
  lift.setTarget(175);
  intake.jam_override = false;
  pros::delay(500);

  chassis.moveToPoint(0, -36, 1200, {.forwards = false, .maxSpeed = 100});
  chassis.turnToPoint(50, -48, 1000, {.minSpeed = 80, .earlyExitRange = 10});
  lift.setTarget(75);
  chassis.moveToPoint(50, -48, 3000, {.maxSpeed = 90, .earlyExitRange = 1});
  doinker.extend();
  ...
  chassis.moveToPoint(60, -72, 1000, {.forwards = false, .maxSpeed = 100});
  doinker.retract();
  pros::delay(200);
  clamp.retract();
  pros::delay(300);
  ...
  pros::delay(200);
  intake.setState(lib::IntakeState::Idle);
  chassis.moveToPoint(-2, -2, 2500, {.forwards = false, .maxSpeed = 75});
  pros::delay(750);
